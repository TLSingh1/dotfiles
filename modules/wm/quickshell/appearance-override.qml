...
// Custom appearance overrides for caelestia
// Copy this to ~/.config/quickshell/caelestia/config/Appearance.qml to apply
...
Singleton {
    ...
    component FontFamily: QtObject {
        // Customize these to your preferred fonts
        readonly property string sans: "IBM Plex Sans"  // or "Noto Sans", "Inter", etc.
        readonly property string mono: "JetBrains Mono" // Remove "NF" if you don't want Nerd Font
