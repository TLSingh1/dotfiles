...
{hostname ? "default"}: let
  ...
  commonBinds = {
    ...
    "Super, Super_L" = "exec, qs ipc call overviewToggleRelease 2>/dev/null || pkill fuzzel || fuzzel";
    
    # Overview and launcher toggles
    "Super, Tab" = "exec, qs ipc call overviewToggle 2>/dev/null";
    "Super, V" = "exec, qs ipc call overviewClipboardToggle 2>/dev/null || pkill fuzzel || cliphist list | fuzzel --match-mode fzf --dmenu | cliphist decode | wl-copy";
    "Super, Period" = "exec, qs ipc call overviewEmojiToggle 2>/dev/null || pkill fuzzel || ~/.config/hypr/hyprland/scripts/fuzzel-emoji.sh copy";
